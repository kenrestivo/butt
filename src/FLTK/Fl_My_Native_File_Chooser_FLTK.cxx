 ...
 */
void Fl_My_Native_File_Chooser::type(int t) { return _x11_file_chooser->type(t); }

/**
 Gets the current Fl_My_Native_File_Chooser::Type of browser.
 */
int Fl_My_Native_File_Chooser::type() const { return _x11_file_chooser->type(); }
...
\endcode
 */
void Fl_My_Native_File_Chooser::options(int o) {  _x11_file_chooser->options(o); }

/**
 Gets the platform specific Fl_My_Native_File_Chooser::Option flags.
 */
int Fl_My_Native_File_Chooser::options() const {  return _x11_file_chooser->options(); }
...
/**
 ...
 \endcode
 */
int Fl_My_Native_File_Chooser::count() const { return _x11_file_chooser->count(); }
 ...
 */
const char *Fl_My_Native_File_Chooser::filename() const { return _x11_file_chooser->filename(); }
...
/**
 ...
 \endcode
 */
const char *Fl_My_Native_File_Chooser::filename(int i) const { return _x11_file_chooser->filename(i); }
 ...
 */
void Fl_My_Native_File_Chooser::directory(const char *val) {  _x11_file_chooser->directory(val); }

/**
 Returns the current preset directory() value.
 */
const char *Fl_My_Native_File_Chooser::directory() const { return _x11_file_chooser->directory(); }
 ...
 */
void Fl_My_Native_File_Chooser::title(const char *t) {  _x11_file_chooser->title(t); }

/**
 Get the title of the file chooser's dialog window.
 Return value may be NULL if no title was set.
 */
const char* Fl_My_Native_File_Chooser::title() const { return _x11_file_chooser->title(); }

/**
 Returns the filter string last set.
 Can be NULL if no filter was set.
 */
const char *Fl_My_Native_File_Chooser::filter() const { return _x11_file_chooser->filter(); }
 ...
 */
void Fl_My_Native_File_Chooser::filter(const char *f) {  _x11_file_chooser->filter(f); }

/**
 Gets how many filters were available, not including "All Files" 
 */
int Fl_My_Native_File_Chooser::filters() const { return _x11_file_chooser->filters(); }
 ...
 */
void Fl_My_Native_File_Chooser::filter_value(int i) {  _x11_file_chooser->filter_value(i); }

/**
 Returns which filter value was last selected by the user.
 This is only valid if the chooser returns success.
 */
int Fl_My_Native_File_Chooser::filter_value() const { return _x11_file_chooser->filter_value(); }
 ...
 */
void Fl_My_Native_File_Chooser::preset_file(const char* f) {  _x11_file_chooser->preset_file(f); }

/**
 Get the preset filename.
 */
const char* Fl_My_Native_File_Chooser::preset_file() const { return _x11_file_chooser->preset_file(); }
 ...
 */
const char *Fl_My_Native_File_Chooser::errmsg() const { return _x11_file_chooser->errmsg(); }
 ...
 */
int Fl_My_Native_File_Chooser::show() { return _x11_file_chooser->show(); }
