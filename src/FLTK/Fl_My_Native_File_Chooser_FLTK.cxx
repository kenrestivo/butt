// "$Id: Fl_My_Native_File_Chooser_FLTK.cxx 9547 2012-05-25 14:46:02Z manolo $"
//
...
int Fl_My_Native_File_Chooser::type_fl_file(int val) {
  switch (val) {
    case BROWSE_FILE:
...
//
void Fl_My_Native_File_Chooser::parse_filter() {
...
int Fl_My_Native_File_Chooser::exist_dialog() {
  return(fl_choice("%s", fl_cancel, fl_ok, NULL, file_exists_message));
}

//
// End of "$Id: Fl_My_Native_File_Chooser_FLTK.cxx 9547 2012-05-25 14:46:02Z manolo $".
//
